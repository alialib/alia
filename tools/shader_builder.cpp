    ...
    bool nul_terminate)
{
...

    {
        ...
        h << "// Generated by alia_shader_builder — do not edit.\n"
          ...
          << "static inline alia_shader_desc\n"
          << desc_fn << "(size_t params_size)\n"
          << "{\n"
          << "    alia_shader_desc desc;\n"
...

    {
        ...
        cpp << "};\n\n"
            ...
            << "alia_shader_format const " << format_sym << " = "
            << format_fourcc << ";\n";
    }
}
