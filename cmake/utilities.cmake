...
function(alia_add_host_library)
    ...
    if(NOT EMSCRIPTEN AND NOT TARGET alia_glfw_platform)
        message(FATAL_ERROR "alia_host requires alia_glfw_platform on desktop")
    endif()
    if(EMSCRIPTEN AND NOT TARGET alia_web_platform)
