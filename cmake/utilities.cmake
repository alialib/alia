...
# Product hosts only: Win32 on Windows desktop, web on Emscripten.
function(alia_add_host_library)
    ...
    elseif(WIN32)
        if(NOT TARGET alia_win32_platform)
            message(FATAL_ERROR "alia_host requires alia_win32_platform")
        endif()
    else()
        message(FATAL_ERROR
            "alia_host is only available on Windows desktop or Emscripten")
    endif()
