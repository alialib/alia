...
static rgb8 const white(0xff, 0xff, 0xff), silver(0xc0, 0xc0, 0xc0),
    ...
    maroon(0x80, 0x00, 0x00), yellow(0xff, 0xff, 0x00), olive(0x80, 0x80, 0x00),
    lime(0x00, 0xff, 0x00), green(0x00, 0x80, 0x00), aqua(0x00, 0xff, 0xff),
    teal(0x00, 0x80, 0x80), blue(0x00, 0x00, 0xff), navy(0x00, 0x00, 0x80),
    fuchsia(0xff, 0x00, 0xff), purple(0x80, 0x00, 0x80);
