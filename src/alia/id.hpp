...
static inline bool
operator==(local_id const& a, local_id const& b)
{
...
struct local_identity
{
    ...
    local_identity(local_identity const& other) : id(generate_local_id())
    {
    }
    local_identity&
    operator=(local_identity const& other)
    {
...
static inline void
inc_version(local_identity& identity)
{
    ++identity.id.version;
}
