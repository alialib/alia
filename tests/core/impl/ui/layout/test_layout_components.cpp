        ...
        [&](alia_context& ctx) {
            grid(ctx, [&](alia_layout_grid_handle grid_handle) {
                ...
                grid_row(ctx, grid_handle, [&]() {
                    ...
                    test_leaf(ctx, alia_vec2f_make(10.f, 10.f), FILL);
                });
            });
        },
        [&](alia_context& ctx) {
...
{
    run_layout_case(
        alia_vec2f_make(130.f, 100.f),
        [&](alia_context& ctx) {
            row(ctx, gap(10.f), [&]() {
                test_leaf(ctx, alia_vec2f_make(50.f, 100.f));
                test_leaf(ctx, alia_vec2f_make(50.f, 100.f));
            });
        },
        [&](alia_context& ctx) {
...
{
    run_layout_case(
        alia_vec2f_make(200.f, 200.f),
        [&](alia_context& ctx) {
            column(ctx, [&]() {
                test_leaf(ctx, alia_vec2f_make(100.f, 100.f), ALIGN_LEFT);
            });
        },
        [&](alia_context& ctx) {
            alia_box box;
            column(ctx, [&]() {
                test_leaf(
                    ctx, alia_vec2f_make(100.f, 100.f), ALIGN_LEFT, &box);
            });
            CHECK(check_box_eq(
                box,
                alia_vec2f_make(0.f, 0.f),
        ...
        [&](alia_context& ctx) {
            grid(ctx, [&](alia_layout_grid_handle grid_handle) {
                ...
                grid_row(ctx, grid_handle, [&]() {
                    test_leaf(ctx, alia_vec2f_make(10.f, 20.f), FILL);
                    test_leaf(
                        ctx, alia_vec2f_make(10.f, 10.f), ALIGN_TOP | ALIGN_LEFT);
                });
            });
        },
        [&](alia_context& ctx) {
