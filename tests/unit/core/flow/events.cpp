...
typedef extend_context_type_t<core_context, my_tag> my_context;
...
TEST_CASE("node IDs", "[flow][events]")
{
    ...
    sys.controller = [&](core_context vanilla_ctx) {
        my_context ctx = add_context_object<my_tag>(vanilla_ctx, ids);
