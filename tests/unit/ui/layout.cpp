    ...
    {                                                                         \
        ...
        {                                                                     \
            ...
            ui_code                                                           \
                                                                              ...
                                                                              \
        REQUIRE(test_leaf1.absolute_position == expected_region1.corner);     \
        REQUIRE(                                                              \
            test_leaf1.node.assignment().region.size                          \
            == expected_region1.size);                                        \
    }

#define DO_2LEAF_TEST(                                                        \
    ui_code, assigned_size, expected_region1, expected_region2)               \
    {                                                                         \
        layout_system system;                                                 \
        data_graph graph;                                                     \
                                                                              \
        ...
        REQUIRE(                                                              \
            test_leaf1.node.assignment().region.size                          \
            == expected_region1.size);                                        \
        REQUIRE(test_leaf2.absolute_position == expected_region2.corner);     \
        REQUIRE(                                                              \
            test_leaf2.node.assignment().region.size                          \
